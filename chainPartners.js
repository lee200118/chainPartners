...
websocket.on("open",    onWsOpen);      //socket open
websocket.on("message", onWsMessage);   //socket message
websocket.on("close",   onWsClose);     //socket close
websocket.on("error",   onWsError);     //socket error
